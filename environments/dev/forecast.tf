...
resource "google_pubsub_topic" "forecast_weather_topic" {
  name = "forecast-weather-topic-dev"
}
...
resource "google_cloud_scheduler_job" "forecast_weather_schedular" {
  name        = "forecast-weather-schedular-dev"
...
resource "google_storage_bucket_object" "dev_forecast_weather_cloud_function" {
  name           = "dev-forecast-weather.zip"
...
resource "google_cloudfunctions_function" "dev_collect_forecast_weather" {
  name                  = "timeseries-mlops-collect-forecast-weather-dev"
  ...
  source_archive_object = google_storage_bucket_object.dev_forecast_weather_cloud_function.name
