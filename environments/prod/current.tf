...
resource "google_pubsub_topic" "realtime_weather_topic" {
  name = "realtime-weather-topic-prod"
}
...
resource "google_cloud_scheduler_job" "realtime_weather_schedular" {
  name        = "realtime-weather-schedular-prod"
...
resource "google_storage_bucket_object" "prod_realtime_weather_cloud_function" {
  name           = "prod-realtime-weather.zip"
...
resource "google_cloudfunctions_function" "prod_collect_realtime_weather" {
  name                  = "timeseries-mlops-collect-realtime-weather-prod"
  ...
  source_archive_object = google_storage_bucket_object.prod_realtime_weather_cloud_function.name
